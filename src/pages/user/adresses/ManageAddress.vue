...
import DeleteAddressDialog from '@/pages/user/adresses/DeleteAddressDialog.vue';
    ...
    <AppLayout>
        <Page max-width="lg">
            <TitleBar title="Alamat">
                <template #action>
                    <Button as-child>
                        <RouterLink :to="{ name: 'user.addresses.create' }"> Tambah Alamat </RouterLink>
                    </Button>
                </template>
            </TitleBar>
            <BlockStack>
                                        ...
                                        <DropdownMenu :modal="false">
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem as-child>
                                                    <RouterLink :to="{ name: 'user.addresses.edit', params: { id: row.id } }">
                                                        Edit alamat
                                                    </RouterLink>
                                                </DropdownMenuItem>
