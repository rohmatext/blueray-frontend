...
import AddressForm from '@/pages/user/adresses/AddressForm.vue';
import AddressFormSkeleton from '@/pages/user/adresses/skeleton/AddressFormSkeleton.vue';
...
<template>
    <AppLayout>
        <Page class="max-w-md">
            <TitleBar title="Edit Alamat" :navigation="{ name: 'user.addresses' }" />
