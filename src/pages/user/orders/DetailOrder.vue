...
import OrderDetailSkeleton from './skeleton/OrderDetailSkeleton.vue';
import OrderTrackingListSkeleton from './skeleton/OrderTrackingListSkeleton.vue';
...
<template>
    <AppLayout>
        <Page max-width="lg">
            <TitleBar title="Detail Pesanan" :navigation="{ name: 'user.orders' }">
